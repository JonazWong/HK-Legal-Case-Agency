...
export default function IndexTestDashboardLanding() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      "use client";
              ...
              <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 text-center">
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                    <Link
                      href="/signup"
                      className="min-w-[240px] inline-flex items-center justify-center rounded-full bg-primary hover:bg-blue-800 text-white font-semibold text-lg py-6"
                    >
                      開始 14 天免費試用
                    </Link>
                    <Link
                      href="/login"
                      className="min-w-[240px] inline-flex items-center justify-center rounded-full border-2 border-accent text-accent hover:bg-accent/10 font-semibold text-lg py-6"
                    >
                      登入
                    </Link>
                  </div>
