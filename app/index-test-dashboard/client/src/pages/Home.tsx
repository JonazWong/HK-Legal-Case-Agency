...
/**
 * Design Philosophy: Professional Enterprise-Grade Dark Theme
 * - Deep dark background with video/gradient overlay
 * - High contrast white text on dark background
 * - Three-color system: Deep Blue (#0066CC) + Teal Green (#00D084) + White (#FFFFFF)
 * - Silver-gray geometric patterns for detail and sophistication
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <Link href="/signup">
                <Button
                  size="lg"
                  className="min-w-[240px] bg-primary hover:bg-blue-800 text-white font-semibold text-lg py-6"
                >
                  開始 14 天免費試用
                </Button>
              </Link>
              <Link href="/login">
                <Button
                  size="lg"
                  variant="outline"
                  className="min-w-[240px] border-2 border-accent text-accent hover:bg-accent/10 font-semibold text-lg py-6"
                >
                  登入
                </Button>
              </Link>
      ...
      <section className="py-20 bg-background border-t border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-card p-8 rounded-lg border border-border hover:border-accent/50 transition-colors">
              ...
              <p className="text-3xl font-bold text-accent mb-4">
                HK$3,100<span className="text-sm text-muted-foreground">/月</span>
              </p>
            ...
            <div className="bg-card p-8 rounded-lg border-2 border-accent relative hover:shadow-lg hover:shadow-accent/20 transition-all">
              ...
              <p className="text-3xl font-bold text-accent mb-4">
                HK$7,000<span className="text-sm text-muted-foreground">/月</span>
              </p>
              <p className="text-muted-foreground text-sm mb-6">
                適合 5-20 人律所
              </p>
            ...
            <div className="bg-card p-8 rounded-lg border border-border hover:border-accent/50 transition-colors">
              ...
              <p className="text-3xl font-bold text-accent mb-4">
                HK$10,100+<span className="text-sm text-muted-foreground">/月</span>
              </p>
              <p className="text-muted-foreground text-sm mb-6">
                適合 20-100 人律所
              </p>
          ...
          <div className="text-center mt-12">
            <Link href="/signup">
              <Button size="lg" className="bg-primary hover:bg-blue-800 text-white font-semibold text-lg py-6 px-8">
                開始免費試用
              </Button>
            </Link>
          </div>
